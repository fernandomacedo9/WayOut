    ...
    */
    ...
    public void openSecondaryTaskTutorial() {
            ...
            if(nextScene == "A1" || nextScene == "A2") {
                ...
                secondaryTaskTutorialText.text = "Due to the energy required to make your body move, occasionally you might overheat, letting out some smoke, at which point you should press [space bar] as fast as you can. Be careful to press [space bar] only when you see smoke or it could have a detrimental effect to you. Miss it 3 times and you will be destroyed, ending the game. On the other hand, continuous successes will make you cooler.";
            } else {
